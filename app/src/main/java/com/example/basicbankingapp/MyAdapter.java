...
public class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public MyAdapter(List<CustomerDetail> users, Context mCtx) {
        this.list = users;
        this.context = mCtx;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        final CustomerDetail userDetails = list.get(i);
    ...
    public void userDetailsMethod(CustomerDetail userDetails){
        Intent intent = new Intent(context,CustomerDetailActivity.class);
        intent.putExtra("id",userDetails.id);
        context.startActivity(intent);
    }

    public void amountUpdate(CustomerDetail userDetails){
